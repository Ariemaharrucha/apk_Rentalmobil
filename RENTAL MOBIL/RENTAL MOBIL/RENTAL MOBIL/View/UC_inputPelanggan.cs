...
namespace RENTAL_MOBIL.Controller
{
    public partial class UC_inputPelanggan : UserControl
    {
        ...
        public UC_inputPelanggan()
        {
            ...
            btn_DeletePelanggan.Enabled = false;
        ...
        private void lvwDataPelanggan_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (IsDataSelected)
            {
                ...
                btn_DeletePelanggan.Enabled = true;
        ...
        private void LoadDataPelanggan()
        {
            ...
            using (SqlConnection connection = new SqlConnection(@"Data Source=DESKTOP-MG9E6H7\SQLEXPRESS;Initial Catalog=Rental_mobil;Integrated Security=True"))
            {
                ...
                string query = @"SELECT Id_pelanggan, Nama_pelanggan,Gender,Alamat,Nik_ktp,No_telepon from Tbl_pelanggan order by Nama_pelanggan ASC";
                ...
                using (SqlCommand command = new SqlCommand(query, connection))
                {
                    using (SqlDataReader reader = command.ExecuteReader())
                    {
                        while (reader.Read())
                        {
                            ...
                            item.SubItems.Add(reader["No_telepon"].ToString());
